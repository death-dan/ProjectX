    ...
    <div class="container content">
        <section class="main_footer_content">
            <article class="main_footer_content_item">
                <h2>Sobre:</h2>
                <p>O CoffeControl é um gerenciador de contas simples, poderoso e gratuito. O prazer de tomar um café e
            ...
            <article class="main_footer_content_item">
                ...
                <p class="icon-envelope"><b>Email:</b><br> coffe@coffecontrol.com</p>
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-facebook"
                   href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CoffeControl no Facebook">/CoffeControl</a>
                <a target="_blank" class="icon-instagram"
                   href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CoffeControl no Instagram">@CoffeControl</a>
                <a target="_blank" class="icon-youtube" href="https://www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>"
                   title="CoffeControl no YouTube">/CoffeControl</a>
            </article>
        </section>
    </div>
</footer>
